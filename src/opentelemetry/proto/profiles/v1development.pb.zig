...
pub const Profile = struct {
    ...
    pub const _desc_table = .{
        ...
        .default_sample_type_index = fd(9, .{ .Varint = .Simple }),
        .profile_id = fd(10, .Bytes),
        .dropped_attributes_count = fd(11, .{ .Varint = .Simple }),
        .original_payload_format = fd(12, .String),
        .original_payload = fd(13, .Bytes),
        .attribute_indices = fd(14, .{ .PackedList = .{ .Varint = .Simple } }),
    };
